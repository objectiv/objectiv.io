          ...
          <div className={clsx('container', styles.cookiesContainer)}>
            ...
            <TrackedDiv id={'cookies-and-related-technologies'}>
              ...
              <p>
                ...
                <TrackedLink to="http://www.networkadvertising.org/choices/" external={true}>Network Advertising 
                Initiative</TrackedLink> or the&nbsp;
                <TrackedLink to="http://www.aboutads.info/choices/" external={true}>Digital Advertising 
                ...
                <TrackedLink to="http://www.youronlinechoices.eu/" external={true}>click here</TrackedLink>). 
