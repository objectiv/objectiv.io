---
id: open-model-hub-identity-resolution
sidebar_position: 2
slug: /modeling/open-model-hub/identity-resolution/
...
[`on creating the Objectiv DataFrame`](/modeling/open-model-hub/api-reference/ModelHub/modelhub.ModelHub.get_objectiv_dataframe.mdx):
...
[`get_objectiv_dataframe`](/modeling/open-model-hub/api-reference/ModelHub/modelhub.ModelHub.get_objectiv_dataframe.mdx) call.
...
[IdentityContext](https://objectiv.io/docs/taxonomy/reference/global-contexts/IdentityContext) and contains
two fields:
...
See the [Tracking section](https://objectiv.io/docs/tracking/) on how to configure the SDK for your
platform to track this IdentityContext.

The method in the `id` field can then be used to configure model hub (in the
[`get_objectiv_dataframe`](/modeling/open-model-hub/api-reference/ModelHub/modelhub.ModelHub.get_objectiv_dataframe.mdx) call) to use all matching IdentityContexts
...
This behavior can be specified in the [`get_objectiv_dataframe`](/modeling/open-model-hub/api-reference/ModelHub/modelhub.ModelHub.get_objectiv_dataframe.mdx)
call.
