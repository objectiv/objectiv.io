...
<h2 className="signature-method"><span className="additional-name">ModelHub.</span><span className="name">get_objectiv_dataframe(</span><small className="parameter-list"><span className="parameter" id="db_url">db_url=None</span>, <span className="parameter" id="table_name">table_name='data'</span>, <span className="parameter" id="start_date">start_date=None</span>, <span className="parameter" id="end_date">end_date=None</span></small>)</h2>
...
Sets data from sql table into an [`bach.DataFrame`](/modeling/bach/api-reference/DataFrame/index.mdx) object.
...
[`bach.DataFrame`](/modeling/bach/api-reference/DataFrame/index.mdx) with Objectiv data.
