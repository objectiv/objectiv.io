...
Sets data from sql table into an [`bach.DataFrame`](/docs/modeling/bach/api-reference/DataFrame) object.
...
[`bach.DataFrame`](/docs/modeling/bach/api-reference/DataFrame) with Objectiv data.
