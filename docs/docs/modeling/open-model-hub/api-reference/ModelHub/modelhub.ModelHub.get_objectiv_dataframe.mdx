...
<small className="parameter-list">(<span className="parameter" id="db_url">db_url=None</span>, <span className="parameter" id="table_name">table_name='data'</span>, <span className="parameter" id="start_date">start_date=None</span>, <span className="parameter" id="end_date">end_date=None</span>, <span className="parameter" id="*">\*</span>, <span className="parameter" id="bq_credentials_path">bq_credentials_path=None</span>)</small>
