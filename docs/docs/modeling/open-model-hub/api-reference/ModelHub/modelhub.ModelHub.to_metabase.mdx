...
[`bach.Series`](/docs/modeling/bach/api-reference/Series), it will call [`bach.Series.to_frame()`](/docs/modeling/bach/api-reference/Series/bach.Series.to-frame).
...
* **`data`** – [`bach.DataFrame`](/docs/modeling/bach/api-reference/DataFrame) or [`bach.Series`](/docs/modeling/bach/api-reference/Series) to push to MetaBase.
