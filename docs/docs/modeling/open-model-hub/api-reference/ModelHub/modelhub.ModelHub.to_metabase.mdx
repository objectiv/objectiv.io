...
<h2 className="signature-method"><span className="additional-name">ModelHub.</span><span className="name">to_metabase(</span><small className="parameter-list"><span className="parameter" id="data">data</span>, <span className="parameter" id="model_type">model_type=None</span>, <span className="parameter" id="config">config=None</span></small>)</h2>
