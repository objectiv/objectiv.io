...
### <span className="type-annotation"><em>property </em></span> <span className="name">map</span>
...
### <span className="name">is_conversion_event</span>
...
### <span className="name">is_first_session</span>
