...
The Objectiv [ModelHub](/modeling/open-model-hub/api-reference/ModelHub/index.mdx#modelhub-reference-modelhub) package comes with a built-in version checker.
...
An HTTP request to [https://version-check.objectiv.io](https://version-check.objectiv.io) is sent on package import. A Python warning
