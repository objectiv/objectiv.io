...
events. [global_contexts](/modeling/example-notebooks/open-taxonomy.mdx) and the [location_stack](/modeling/example-notebooks/open-taxonomy.mdx) contain most of the event specific data.
