...
title: Feature engineering with Bach
---
...
[here](/docs/modeling/example-notebooks/machine-learning).

This example is also available in a [notebook](https://github.com/objectiv/objectiv-analytics/blob/main/notebooks/feature-engineering.ipynb)
...
[Getting started with Objectiv](/docs/modeling/example-notebooks/feature-engineering/) for more info on this.
...
events. [global_contexts](/docs/modeling/example-notebooks/open-taxonomy) and the [location_stack](/docs/modeling/example-notebooks/open-taxonomy) contain most of the event specific data.
