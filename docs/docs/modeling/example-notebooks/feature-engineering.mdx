...
[here](/modeling/example-notebooks/machine-learning.mdx#example-machine-learning).
...
events. [global_contexts](/modeling/example-notebooks/open-taxonomy.mdx#global-contexts) and the [location_stack](/modeling/example-notebooks/open-taxonomy.mdx#location-stack) contain most of the event specific data.
