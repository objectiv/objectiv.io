...
[get_from_context_with_type_series](/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.objectiv.mdx#get-from-context-with-type-series). Or use methods
specific to the [location_stack](/modeling/example-notebooks/open-taxonomy.mdx#location-stack) or [global_contexts](/modeling/example-notebooks/open-taxonomy.mdx#global-contexts) to
extract the data.
...
A good starting point for these analyses on top of the user intent buckets is the basic product analytics example in the [example notebooks](/modeling/example-notebooks/index.mdx#example-notebooks).
