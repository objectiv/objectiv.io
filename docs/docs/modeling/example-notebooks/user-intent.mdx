...
title: Basic user intent analysis
---
...
This example is also available in a [notebook](https://github.com/objectiv/objectiv-analytics/blob/main/notebooks/basic-user-intent.ipynb)
...
[Getting started with Objectiv](/docs/modeling/example-notebooks/user-intent/) for more info on this. The data used in this example is
...
A good starting point for these analyses on top of the user intent buckets is the basic product analytics example in the [example notebooks](/docs/modeling/example-notebooks/user-intent/).
