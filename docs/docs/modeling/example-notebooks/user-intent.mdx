...
[Getting started with Objectiv](/modeling/example-notebooks/index.mdx) for more info on this. The data used in this example is
...
[get_from_context_with_type_series](/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.objectiv.mdx). Or use methods
specific to the [location_stack](/modeling/example-notebooks/open-taxonomy.mdx) or [global_contexts](/modeling/example-notebooks/open-taxonomy.mdx) to
extract the data.
...
A good starting point for these analyses on top of the user intent buckets is the basic product analytics example in the [example notebooks](/modeling/example-notebooks/index.mdx).
