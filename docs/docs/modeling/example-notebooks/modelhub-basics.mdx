...
The model hub has two main type of functions:
[helper functions](/modeling/open-model-hub/models/helper-functions/index.mdx) and
[aggregation](/modeling/open-model-hub/models/aggregation/index.mdx).
