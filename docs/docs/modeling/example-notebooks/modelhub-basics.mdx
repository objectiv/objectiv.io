...
conjunction with, [Bach](/docs/modeling/bach), our modeling library.
...
[Getting started with Objectiv](/docs/modeling/example-notebooks/modelhub-basics/) for more info on this.
...
The model hub has two main type of functions: [Mapping](/docs/modeling/open-model-hub/models/Mapping) and
[Aggregation](/docs/modeling/open-model-hub/models/Aggregation).
...
(this is called the location stack, see [location_stack](/docs/modeling/example-notebooks/open-taxonomy) for info).
...
There is another [example](/docs/modeling/bach/examples) that demonstrates what you can do with the Bach modeling
library, or head over to the [Bach API reference](/docs/modeling/bach/api-reference) for a complete overview of the possibilities.
...
For a complete overview of all available and upcoming models, check out the [models](/docs/modeling/open-model-hub/models).
