...
conjunction with, [Bach](/modeling/bach/index.mdx), our modeling library. It’s also available in a [notebook](https://github.com/objectiv/objectiv-analytics/blob/main/notebooks/model-hub-demo-notebook.ipynb)
