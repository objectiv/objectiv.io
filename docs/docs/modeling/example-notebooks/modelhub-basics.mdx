...
The model hub has two main type of functions: [Map](/modeling/open-model-hub/models/Map/index.mdx) and
[Aggregate](/modeling/open-model-hub/models/Aggregate/index.mdx).
