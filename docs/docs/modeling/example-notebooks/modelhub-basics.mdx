...
The model hub has two main type of functions: [Mapping](/modeling/open-model-hub/models/Mapping/index.mdx) and
...
(this is called the location stack, see [location_stack](/modeling/example-notebooks/open-taxonomy.mdx) for info).
...
library, or head over to the [Bach API reference](/modeling/bach/api-reference/index.mdx) for a complete overview of the possibilities.
