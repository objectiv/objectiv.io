...
In case a json array does not contain the object, `None` is returned. More info at the [API reference](/modeling/bach/api-reference/Series/Jsonb/index.mdx).
...
* The property accessors:
      * [.ls.navigation_features](/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.ls.mdx)
      * [.ls.feature_stack](/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.ls.mdx)
      * [.ls.nice_name](/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.ls.mdx)


* all [methods](/modeling/bach/api-reference/Series/Jsonb/index.mdx) for the json(b) type can also be accessed using `.ls`
...
* [.gc.get_from_context_with_type_series(type, key)](/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.objectiv.mdx).
* The property accessors:
      * [.gc.cookie_id](/modeling/open-model-hub/api-reference/SeriesGlobalContexts/modelhub.SeriesGlobalContexts.global_contexts.mdx)
      * [.gc.user_agent](/modeling/open-model-hub/api-reference/SeriesGlobalContexts/modelhub.SeriesGlobalContexts.global_contexts.mdx)
      * [.gc.application](/modeling/open-model-hub/api-reference/SeriesGlobalContexts/modelhub.SeriesGlobalContexts.global_contexts.mdx)


* all [methods](/modeling/bach/api-reference/Series/Jsonb/index.mdx) for the json(b) type can also be accessed using `.gc`
...
The full Objectiv Bach API reference is available [here](/modeling/bach/api-reference/index.mdx).

There is another example that focuses on using the [open model hub](/modeling/example-notebooks/modelhub-basics.mdx),
