...
[Getting started with Objectiv](/docs/modeling/example-notebooks/open-taxonomy/) for more info on this.
...
In case a json array does not contain the object, `None` is returned. More info at the [API reference](/docs/modeling/bach/api-reference/Series/Jsonb).
...
* The property accessors [.ls.navigation_features](/docs/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.ls), [.ls.feature_stack](/docs/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.ls), [.ls.nice_name](/docs/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.ls).


* all [methods](/docs/modeling/bach/api-reference/Series/Jsonb) for the json(b) type can also be accessed using `.ls`
...
* [.gc.get_from_context_with_type_series(type, key)](/docs/modeling/open-model-hub/api-reference/SeriesLocationStack/modelhub.SeriesLocationStack.objectiv).


* The property accessors [.gc.cookie_id](/docs/modeling/open-model-hub/api-reference/SeriesGlobalContexts/modelhub.SeriesGlobalContexts.global-contexts), [.gc.user_agent](/docs/modeling/open-model-hub/api-reference/SeriesGlobalContexts/modelhub.SeriesGlobalContexts.global-contexts), [.gc.application](/docs/modeling/open-model-hub/api-reference/SeriesGlobalContexts/modelhub.SeriesGlobalContexts.global-contexts).


* all [methods](/docs/modeling/bach/api-reference/Series/Jsonb) for the json(b) type can also be accessed using `.gc`
...
The full Objectiv Bach API reference is available [here](/docs/modeling/bach/api-reference).

There is another example that focuses on using the [open model hub](/docs/modeling/example-notebooks/modelhub-basics),
