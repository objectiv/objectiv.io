...
To get a taste of what you can do with Objectiv Bach, There is a [demo](/docs/home/quickstart-guide) available that enables you to run the full Objectiv pipeline on your local
