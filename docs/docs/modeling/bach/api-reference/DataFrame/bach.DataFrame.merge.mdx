...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">merge(</span><small class="parameter-list"><span class="parameter" id="right">right</span>, <span class="parameter" id="how">how='inner'</span>, <span class="parameter" id="on">on=None</span>, <span class="parameter" id="left_on">left_on=None</span>, <span class="parameter" id="right_on">right_on=None</span>, <span class="parameter" id="left_index">left_index=False</span>, <span class="parameter" id="right_index">right_index=False</span>, <span class="parameter" id="suffixes">suffixes=('_x', '_y')</span></small>
