...
* **`right`** (Union[[DataFrame](/modeling/bach/api-reference/DataFrame/index.mdx), [Series](/modeling/bach/api-reference/Series/index.mdx)]) – DataFrame or Series to join on self
* **`how`** (str) – supported values: {‘left’, ‘right’, ‘outer’, ‘inner’, ‘cross’}
* **`on`** (Union[str, [SeriesBoolean](/modeling/bach/api-reference/Series/Boolean/index.mdx), List[Union[str, [SeriesBoolean](/modeling/bach/api-reference/Series/Boolean/index.mdx)]]]) – optional, column(s) to join left and right on.
