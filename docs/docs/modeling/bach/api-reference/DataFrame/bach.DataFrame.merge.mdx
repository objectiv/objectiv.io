...
If variables are set (see [`DataFrame.variables()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.variables)), then values from self will be used in cases
...
* **`right`** (Union[[DataFrame](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame), [Series](/docs/modeling/bach/api-reference/Series/bach.Series)]) – DataFrame or Series to join on self
