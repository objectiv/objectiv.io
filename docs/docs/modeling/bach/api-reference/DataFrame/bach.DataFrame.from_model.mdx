...
* **`engine`** (_sqlalchemy.engine.base.Engine) – a sqlalchemy engine for the database.

* **`model`** (_sql_models.model.SqlModel) – an SqlModel that specifies the queries to instantiate as DataFrame.
