...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">get_dummies(</span><small className="parameter-list"><span className="parameter" id="prefix">prefix=None</span>, <span className="parameter" id="prefix_sep">prefix_sep='_'</span>, <span className="parameter" id="dummy_na">dummy_na=False</span>, <span className="parameter" id="columns">columns=None</span>, <span className="parameter" id="dtype">dtype='int64'</span></small>)</h2>
...
[bach.dataframe.DataFrame](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.get_dummies/)
