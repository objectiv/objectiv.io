...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">dropna(</span><small class="parameter-list"><span class="parameter" id="*">\*</span>, <span class="parameter" id="axis">axis=0</span>, <span class="parameter" id="how">how='any'</span>, <span class="parameter" id="thresh">thresh=None</span>, <span class="parameter" id="subset">subset=None</span></small>
