...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">expanding(</span><small className="parameter-list"><span className="parameter" id="min_periods">min_periods=1</span>, <span className="parameter" id="center">center=False</span></small>)</h2>
