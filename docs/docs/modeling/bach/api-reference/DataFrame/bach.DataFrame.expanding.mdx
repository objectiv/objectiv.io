...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">expanding(</span><small class="parameter-list"><span class="parameter" id="min_periods">min_periods=1</span>, <span class="parameter" id="center">center=False</span></small>
