...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">groupby(</span><small class="parameter-list"><span class="parameter" id="by">by=None</span></small>
