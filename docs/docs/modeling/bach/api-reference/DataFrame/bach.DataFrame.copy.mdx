...
<h2 class="signature-method"><span class="additional-name">DataFrame.</span><span class="name">copy(</span><small class="parameter-list"></small>)</h2>
...
If you want to create a snapshot of the data, have a look at [`get_sample()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.get-sample)
