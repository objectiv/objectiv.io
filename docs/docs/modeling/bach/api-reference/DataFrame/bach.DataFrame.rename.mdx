...
## <span className="additional-name">DataFrame.</span><span className="name">rename</span>

<small className="parameter-list">(<span className="parameter" id="mapper">mapper=None</span>, <span className="parameter" id="index">index=None</span>, <span className="parameter" id="columns">columns=None</span>, <span className="parameter" id="axis">axis=0</span>, <span className="parameter" id="level">level=None</span>, <span className="parameter" id="errors">errors='ignore'</span></small>)
