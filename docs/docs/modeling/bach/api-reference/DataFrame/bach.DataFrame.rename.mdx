...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">rename(</span><small class="parameter-list"><span class="parameter" id="mapper">mapper=None</span>, <span class="parameter" id="index">index=None</span>, <span class="parameter" id="columns">columns=None</span>, <span class="parameter" id="axis">axis=0</span>, <span class="parameter" id="level">level=None</span>, <span class="parameter" id="errors">errors='ignore'</span></small>
