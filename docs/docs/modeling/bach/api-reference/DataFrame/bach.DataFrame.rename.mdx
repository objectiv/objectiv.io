...
`self.`[`data`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.data) or `self.`[`index`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.index), after renaming is complete.
