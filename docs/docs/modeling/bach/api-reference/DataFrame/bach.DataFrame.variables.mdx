...
<h2 class="signature-property"><span class="type-annotation"><em>property</em></span> <span class="additional-name">DataFrame.</span><span class="name">variables</span><span class="type-annotation"><em>: Dict[bach.dataframe.DtypeNamePair, Hashable]
