...
Calling materialize() resets the order of the dataframe. Call [`sort_values()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.sort-values/#bach.DataFrame.sort-values) again on
