...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">nunique(</span><small className="parameter-list"><span className="parameter" id="axis">axis=1</span>, <span className="parameter" id="skipna">skipna=True</span>, <span className="parameter" id="**">\*\*kwargs</span></small>)</h2>
