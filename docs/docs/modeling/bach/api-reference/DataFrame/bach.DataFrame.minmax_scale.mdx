...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">minmax_scale(</span><small class="parameter-list"><span class="parameter" id="feature_range">feature_range=(0, 1)</span></small>
