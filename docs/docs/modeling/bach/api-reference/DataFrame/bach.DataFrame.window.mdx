...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">window(</span><small class="parameter-list"><span class="parameter" id="**">\*\*frame_args</span></small>
