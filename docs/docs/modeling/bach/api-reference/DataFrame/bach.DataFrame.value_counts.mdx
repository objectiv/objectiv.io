...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">value_counts(</span><small className="parameter-list"><span className="parameter" id="subset">subset=None</span>, <span className="parameter" id="normalize">normalize=False</span>, <span className="parameter" id="sort">sort=True</span>, <span className="parameter" id="ascending">ascending=False</span></small>)</h2>
