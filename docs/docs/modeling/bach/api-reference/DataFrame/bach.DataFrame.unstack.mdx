...
<h2 class="signature-method"><span class="additional-name">DataFrame.</span><span class="name">unstack(</span><small class="parameter-list"><span class="parameter" id="level">level=- 1</span>, <span class="parameter" id="fill_value">fill_value=None</span>, <span class="parameter" id="aggregation">aggregation='max'</span></small>)</h2>
...
methods that [`aggregate()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.aggregate) supports.
