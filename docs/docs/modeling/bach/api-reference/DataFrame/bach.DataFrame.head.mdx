...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">head(</span><small class="parameter-list"><span class="parameter" id="n">n=5</span></small>
