...
<h2 className="signature-method"><span className="type-annotation"><em>classmethod</em></span> <span className="additional-name">DataFrame.</span><span className="name">from_table(</span><small className="parameter-list"><span className="parameter" id="engine">engine</span>, <span className="parameter" id="table_name">table_name</span>, <span className="parameter" id="index">index</span>, <span className="parameter" id="all_dtypes">all_dtypes=None</span>, <span className="parameter" id="*">\*</span>, <span className="parameter" id="bq_dataset">bq_dataset=None</span>, <span className="parameter" id="bq_project_id">bq_project_id=None</span></small>)</h2>
