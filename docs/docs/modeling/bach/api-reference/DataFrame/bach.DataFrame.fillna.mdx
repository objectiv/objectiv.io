...
### <span className="name">fillna</span>

<small className="parameter-list">(<span className="parameter" id="*">\*</span>, <span className="parameter" id="value">value=None</span>, <span className="parameter" id="method">method=None</span>, <span className="parameter" id="axis">axis=0</span>, <span className="parameter" id="sort_by">sort_by=None</span>, <span className="parameter" id="ascending">ascending=True</span>)</small>
...
* **`value`** (Union[[Series](/modeling/bach/api-reference/Series/bach.Series.mdx), int, numpy.int64, float, numpy.float64, bool, None, str, datetime.date, datetime.time, datetime.datetime, numpy.datetime64, datetime.timedelta, numpy.timedelta64, uuid.UUID, pandas._libs.interval.Interval, dict, list, Dict[str, Union[int, numpy.int64, float, numpy.float64, bool, None, str, datetime.date, datetime.time, datetime.datetime, numpy.datetime64, datetime.timedelta, numpy.timedelta64, uuid.UUID, pandas._libs.interval.Interval, dict, list, [Series](/modeling/bach/api-reference/Series/bach.Series.mdx)]]]) – A literal/series to fill all NULL values on each series
