...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">fillna(</span><small class="parameter-list"><span class="parameter" id="*">\*</span>, <span class="parameter" id="value">value=None</span>, <span class="parameter" id="method">method=None</span>, <span class="parameter" id="axis">axis=0</span>, <span class="parameter" id="sort_by">sort_by=None</span>, <span class="parameter" id="ascending">ascending=True</span></small>
