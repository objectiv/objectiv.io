...
* **`value`** (Union[[Series](/modeling/bach/api-reference/Series/index.mdx), int, numpy.int64, float, numpy.float64, bool, None, str, datetime.date, datetime.time, datetime.datetime, datetime.timedelta, numpy.timedelta64, uuid.UUID, dict, list, Dict[str, Union[int, numpy.int64, float, numpy.float64, bool, None, str, datetime.date, datetime.time, datetime.datetime, datetime.timedelta, numpy.timedelta64, uuid.UUID, dict, list, [Series](/modeling/bach/api-reference/Series/index.mdx)]]]) – A literal/series to fill all NULL values on each series
