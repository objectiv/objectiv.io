...
<h2 class="signature-method"><span class="additional-name">DataFrame.</span><span class="name">quantile(</span><small class="parameter-list"><span class="parameter" id="q">q=0.5</span>, <span class="parameter" id="axis">axis=1</span>, <span class="parameter" id="**">\*\*kwargs</span></small>)</h2>
