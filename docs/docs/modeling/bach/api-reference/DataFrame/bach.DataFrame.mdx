...
| [`database_create_table`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.database_create_table.mdx)(table_name, \*[, if_exists]) | Write the current state of the DataFrame to a database table.                          |
...
| [`columns`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.columns.mdx)                                           | Get all the data Series' names in a List                                                                                                    |
