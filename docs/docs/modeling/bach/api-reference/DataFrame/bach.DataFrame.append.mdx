...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">append(</span><small class="parameter-list"><span class="parameter" id="other">other</span>, <span class="parameter" id="ignore_index">ignore_index=False</span>, <span class="parameter" id="sort">sort=False</span></small>
