...
**`by`** (_Optional_[_Union_[_str_, [Series](/docs/modeling/bach/api-reference/Series/bach.Series/#bach.Series), List[Union[str, [Series](/docs/modeling/bach/api-reference/Series/bach.Series/#bach.Series)]]]]) – the series to group by and roll up. Can be a column or index name str, a Series or a list
