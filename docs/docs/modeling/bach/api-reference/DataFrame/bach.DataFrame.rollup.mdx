...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">rollup(</span><small class="parameter-list"><span class="parameter" id="by">by</span></small>
