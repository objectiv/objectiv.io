...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">set_index(</span><small class="parameter-list"><span class="parameter" id="keys">keys</span>, <span class="parameter" id="drop">drop=True</span>, <span class="parameter" id="append">append=False</span></small>
