...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">ffill(</span><small className="parameter-list"><span className="parameter" id="sort_by">sort_by=None</span>, <span className="parameter" id="ascending">ascending=True</span></small>)</h2>
...
[bach.dataframe.DataFrame](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.ffill/)
