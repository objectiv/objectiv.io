...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">reset_index(</span><small class="parameter-list"><span class="parameter" id="level">level=None</span>, <span class="parameter" id="drop">drop=False</span></small>
