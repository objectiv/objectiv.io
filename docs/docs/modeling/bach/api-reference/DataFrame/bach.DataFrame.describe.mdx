...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">describe(</span><small className="parameter-list"><span className="parameter" id="percentiles">percentiles=None</span>, <span className="parameter" id="include">include=None</span>, <span className="parameter" id="exclude">exclude=None</span>, <span className="parameter" id="datetime_is_numeric">datetime_is_numeric=False</span></small>)</h2>
...
[bach.dataframe.DataFrame](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.describe/)
