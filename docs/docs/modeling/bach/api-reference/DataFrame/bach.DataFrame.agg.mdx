...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">agg(</span><small className="parameter-list"><span className="parameter" id="func">func</span>, <span className="parameter" id="axis">axis=1</span>, <span className="parameter" id="numeric_only">numeric_only=False</span>, <span className="parameter" id="*">\*args</span>, <span className="parameter" id="**">\*\*kwargs</span></small>)</h2>
