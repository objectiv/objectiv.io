...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">astype(</span><small class="parameter-list"><span class="parameter" id="dtype">dtype</span></small>
