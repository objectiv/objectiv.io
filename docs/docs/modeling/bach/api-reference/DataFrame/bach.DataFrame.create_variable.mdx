...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">create_variable(</span><small className="parameter-list"><span className="parameter" id="name">name</span>, <span className="parameter" id="value">value</span>, <span className="parameter" id="*">\*</span>, <span className="parameter" id="dtype">dtype=None</span></small>)</h2>
...
DataFrame will have the variable with the given values set in `DataFrame.variables()`.
...
*Tuple*[[DataFrame](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.create_variable/), [Series](/docs/modeling/bach/api-reference/Series)]
