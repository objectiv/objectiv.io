...
<div>
<h2 class="signature-class"><span class="type-annotation"><em>property</em></span> <span class="additional-name">DataFrame.</span><span class="name">loc(</span>)</h2>
...
**NOTE**: * .loc supports access-only for first-level index.
