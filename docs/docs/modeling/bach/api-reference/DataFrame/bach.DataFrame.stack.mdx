...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">stack(</span><small class="parameter-list"><span class="parameter" id="dropna">dropna=True</span></small>
