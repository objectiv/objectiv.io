...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">sem(</span><small className="parameter-list"><span className="parameter" id="axis">axis=1</span>, <span className="parameter" id="skipna">skipna=True</span>, <span className="parameter" id="level">level=None</span>, <span className="parameter" id="ddof">ddof=1</span>, <span className="parameter" id="numeric_only">numeric_only=False</span>, <span className="parameter" id="**">\*\*kwargs</span></small>)</h2>
