...
<h2 class="signature-method"><span class="additional-name">DataFrame.</span><span class="name">sort_values(</span><small class="parameter-list"><span class="parameter" id="by">by</span>, <span class="parameter" id="ascending">ascending=True</span></small>)</h2>
...
are for example [`groupby()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.groupby), [`merge()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.merge), [`materialize()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.materialize), and filtering out rows.
