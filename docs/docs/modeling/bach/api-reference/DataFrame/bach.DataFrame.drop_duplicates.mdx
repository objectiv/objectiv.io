...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">drop_duplicates(</span><small class="parameter-list"><span class="parameter" id="subset">subset=None</span>, <span class="parameter" id="keep">keep='first'</span>, <span class="parameter" id="ignore_index">ignore_index=False</span>, <span class="parameter" id="sort_by">sort_by=None</span>, <span class="parameter" id="ascending">ascending=True</span></small>
