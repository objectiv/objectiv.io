...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">view_sql(</span><small className="parameter-list"><span className="parameter" id="limit">limit=None</span></small>)</h2>
