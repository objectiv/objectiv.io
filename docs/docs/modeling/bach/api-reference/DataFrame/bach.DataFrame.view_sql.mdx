...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">view_sql(</span><small class="parameter-list"><span class="parameter" id="limit">limit=None</span></small>
