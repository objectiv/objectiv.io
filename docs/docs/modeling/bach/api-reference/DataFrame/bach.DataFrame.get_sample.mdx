...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">get_sample(</span><small class="parameter-list"><span class="parameter" id="table_name">table_name</span>, <span class="parameter" id="filter">filter=None</span>, <span class="parameter" id="sample_percentage">sample_percentage=None</span>, <span class="parameter" id="overwrite">overwrite=False</span>, <span class="parameter" id="seed">seed=None</span></small>
