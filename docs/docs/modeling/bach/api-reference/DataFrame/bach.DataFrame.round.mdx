...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">round(</span><small class="parameter-list"><span class="parameter" id="decimals">decimals=0</span></small>
