...
<small className="parameter-list">(<span className="parameter" id="engine">engine</span>, <span className="parameter" id="df">df</span>, <span className="parameter" id="convert_objects">convert_objects</span>, <span className="parameter" id="name">name='loaded_data'</span>, <span className="parameter" id="materialization">materialization='cte'</span>, <span className="parameter" id="*">\*</span>, <span className="parameter" id="if_exists">if_exists='fail'</span>)</small>
