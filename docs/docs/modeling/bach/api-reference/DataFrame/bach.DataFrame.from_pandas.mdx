...
<div class="method">
<h2 class="signature-class"><span class="type-annotation"><em>classmethod</em></span> <span class="additional-name">DataFrame.</span><span class="name">from_pandas(</span><small class="parameter-list"><span class="parameter" id="engine">engine</span>, <span class="parameter" id="df">df</span>, <span class="parameter" id="convert_objects">convert_objects</span>, <span class="parameter" id="name">name='loaded_data'</span>, <span class="parameter" id="materialization">materialization='cte'</span>, <span class="parameter" id="if_exists">if_exists='fail'</span></small>
