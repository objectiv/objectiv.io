...
<h2 className="signature-method"><span className="additional-name">DataFrame.</span><span className="name">scale(</span><small className="parameter-list"><span className="parameter" id="with_mean">with_mean=True</span>, <span className="parameter" id="with_std">with_std=True</span></small>)</h2>
...
[bach.dataframe.DataFrame](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.scale/)
