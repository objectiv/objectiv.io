...
<div class="method">
<h2 class="signature-class"><span class="additional-name">DataFrame.</span><span class="name">scale(</span><small class="parameter-list"><span class="parameter" id="with_mean">with_mean=True</span>, <span class="parameter" id="with_std">with_std=True</span></small>
