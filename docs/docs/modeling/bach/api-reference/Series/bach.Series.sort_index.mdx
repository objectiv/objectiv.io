...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Series.</span><span class="name">sort_index(</span><small class="parameter-list"><span class="parameter" id="*">\*</span>, <span class="parameter" id="ascending">ascending=True</span></small>
