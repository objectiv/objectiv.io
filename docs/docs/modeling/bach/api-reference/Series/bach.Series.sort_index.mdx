...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">sort_index(</span><small className="parameter-list"><span className="parameter" id="*">\*</span>, <span className="parameter" id="ascending">ascending=True</span></small>)</h2>
