...
cast to the jsonb type. As a result all methods of the [`SeriesJsonb`](/modeling/bach/api-reference/Series/Jsonb/index.mdx) can also be used with this
`json` type series.
