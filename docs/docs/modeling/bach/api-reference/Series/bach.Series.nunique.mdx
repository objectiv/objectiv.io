...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">nunique(</span><small className="parameter-list"><span className="parameter" id="partition">partition=None</span>, <span className="parameter" id="skipna">skipna=True</span></small>)</h2>
