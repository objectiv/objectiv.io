...
## <span className="type-annotation"><em>property </em></span> <span className="additional-name">SeriesJsonb.</span><span className="name">json</span>
...
## <span className="additional-name">Json.</span><span className="name">\__getitem__</span>
...
## <span className="additional-name">Json.</span><span className="name">get_value</span>
