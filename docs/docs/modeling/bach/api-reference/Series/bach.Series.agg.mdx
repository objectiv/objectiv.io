...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">agg(</span><small className="parameter-list"><span className="parameter" id="func">func</span>, <span className="parameter" id="group_by">group_by=None</span>, <span className="parameter" id="*">\*args</span>, <span className="parameter" id="**">\*\*kwargs</span></small>)</h2>
...
*Union*[[DataFrame](/docs/modeling/bach/api-reference/DataFrame), [Series](/docs/modeling/bach/api-reference/Series/bach.Series.agg/)]
