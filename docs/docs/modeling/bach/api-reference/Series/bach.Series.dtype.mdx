...
<h2><span className="additional-name">Series.</span><span className="name">dtype(</span><span className="type-annotation"><em>: st</em></span> <span className="type-annotation"><em> = '</em></span> )</h2>
