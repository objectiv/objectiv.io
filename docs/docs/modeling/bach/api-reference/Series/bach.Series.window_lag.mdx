...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Series.</span><span class="name">window_lag(</span><small class="parameter-list"><span class="parameter" id="offset">offset=1</span>, <span class="parameter" id="default">default=None</span>, <span class="parameter" id="window">window=None</span></small>
