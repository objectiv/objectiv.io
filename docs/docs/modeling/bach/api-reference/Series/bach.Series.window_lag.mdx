...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">window_lag(</span><small className="parameter-list"><span className="parameter" id="offset">offset=1</span>, <span className="parameter" id="default">default=None</span>, <span className="parameter" id="window">window=None</span></small>)</h2>
