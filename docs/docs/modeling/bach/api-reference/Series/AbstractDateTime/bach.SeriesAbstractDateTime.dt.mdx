...
## <span className="type-annotation"><em>property </em></span> <span className="additional-name">SeriesAbstractDateTime.</span><span className="name">dt</span>
...
## <span className="additional-name">DateTimeOperation.</span><span className="name">sql_format</span>
