...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Series.</span><span class="name">value_counts(</span><small class="parameter-list"><span class="parameter" id="normalize">normalize=False</span>, <span class="parameter" id="sort">sort=True</span>, <span class="parameter" id="ascending">ascending=False</span>, <span class="parameter" id="bins">bins=None</span>, <span class="parameter" id="method">method='pandas'</span></small>
