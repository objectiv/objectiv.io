...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">value_counts(</span><small className="parameter-list"><span className="parameter" id="normalize">normalize=False</span>, <span className="parameter" id="sort">sort=True</span>, <span className="parameter" id="ascending">ascending=False</span>, <span className="parameter" id="bins">bins=None</span>, <span className="parameter" id="method">method='pandas'</span></small>)</h2>
...
[bach.series.series.Series](/docs/modeling/bach/api-reference/Series/bach.Series.value_counts/)
