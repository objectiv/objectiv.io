...
|                                                   |                                                                                                                                                                                                     |
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`SeriesBoolean.max`](/modeling/bach/api-reference/Series/Boolean/bach.SeriesBoolean.max.mdx)([partition, skipna])            | Returns the maximum value in the partition, i.e. value will be False iif all values in the partition are False.                                                                                     |
| [`SeriesBoolean.min`](/modeling/bach/api-reference/Series/Boolean/bach.SeriesBoolean.min.mdx)([partition, skipna])            | Returns the minimum value in the partition, i.e. value will be True iif all values in the partition are True.                                                                                       |
