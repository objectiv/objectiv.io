...
|                                                   |                                                                                                                                                                                                     |
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`SeriesBoolean.max`](/docs/modeling/bach/api-reference/Series/Boolean/bach.SeriesBoolean.max)([partition, skipna])            | Returns the maximum value in the partition.                                                                                                                                                         |
| [`SeriesBoolean.min`](/docs/modeling/bach/api-reference/Series/Boolean/bach.SeriesBoolean.min)([partition, skipna])            | Returns the minimum value in the partition.                                                                                                                                                         |
