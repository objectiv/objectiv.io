...
## <span className="additional-name">Series.</span><span className="name">drop_duplicates</span>

<small className="parameter-list">(<span className="parameter" id="keep">keep='first'</span></small>)
