...
<h2 class="signature-method"><span class="additional-name">Series.</span><span class="name">drop_duplicates(</span><small class="parameter-list"><span class="parameter" id="keep">keep='first'</span></small>)</h2>
