...
<div class="method">
<h2 class="signature-class"><span class="type-annotation"><em>classmethod</em></span> <span class="additional-name">Series.</span><span class="name">from_const(</span><small class="parameter-list"><span class="parameter" id="base">base</span>, <span class="parameter" id="value">value</span>, <span class="parameter" id="name">name</span></small>)</h2>
