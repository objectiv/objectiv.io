...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Series.</span><span class="name">apply_func(</span><small class="parameter-list"><span class="parameter" id="func">func</span>, <span class="parameter" id="*">\*args</span>, <span class="parameter" id="**">\*\*kwargs</span></small>
