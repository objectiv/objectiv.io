...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">apply_func(</span><small className="parameter-list"><span className="parameter" id="func">func</span>, <span className="parameter" id="*">\*args</span>, <span className="parameter" id="**">\*\*kwargs</span></small>)</h2>
