...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Series.</span><span class="name">fillna(</span><small class="parameter-list"><span class="parameter" id="other">other</span></small>
