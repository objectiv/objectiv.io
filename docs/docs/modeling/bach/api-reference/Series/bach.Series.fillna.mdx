...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">fillna(</span><small className="parameter-list"><span className="parameter" id="other">other</span></small>)</h2>
