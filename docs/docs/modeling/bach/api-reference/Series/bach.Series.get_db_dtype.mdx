...
<h2 class="signature-method"><span class="type-annotation"><em>classmethod</em></span> <span class="additional-name">Series.</span><span class="name">get_db_dtype(</span><small class="parameter-list"><span class="parameter" id="dialect">dialect</span></small>)</h2>
