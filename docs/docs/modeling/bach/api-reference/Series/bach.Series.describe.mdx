...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">describe(</span><small className="parameter-list"><span className="parameter" id="percentiles">percentiles=None</span>, <span className="parameter" id="datetime_is_numeric">datetime_is_numeric=False</span></small>)</h2>
...
[bach.series.series.Series](/docs/modeling/bach/api-reference/Series/bach.Series.describe/)
