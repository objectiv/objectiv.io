...
<h2 class="signature-method"><span class="additional-name">Series.</span><span class="name">describe(</span><small class="parameter-list"><span class="parameter" id="percentiles">percentiles=None</span>, <span class="parameter" id="datetime_is_numeric">datetime_is_numeric=False</span></small>)</h2>
