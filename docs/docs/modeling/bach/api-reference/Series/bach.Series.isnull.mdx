...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">isnull(</span><small className="parameter-list"></small>)</h2>
...
[`notnull`](/docs/modeling/bach/api-reference/Series/bach.Series.notnull)
