...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">window_row_number(</span><small className="parameter-list"><span className="parameter" id="window">window=None</span></small>)</h2>
