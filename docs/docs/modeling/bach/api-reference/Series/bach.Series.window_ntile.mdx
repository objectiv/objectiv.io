...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">window_ntile(</span><small className="parameter-list"><span className="parameter" id="num_buckets">num_buckets=1</span>, <span className="parameter" id="window">window=None</span></small>)</h2>
