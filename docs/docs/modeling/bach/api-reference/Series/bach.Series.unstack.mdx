...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Series.</span><span class="name">unstack(</span><small class="parameter-list"><span class="parameter" id="level">level=- 1</span>, <span class="parameter" id="fill_value">fill_value=None</span>, <span class="parameter" id="aggregation">aggregation='max'</span></small>
