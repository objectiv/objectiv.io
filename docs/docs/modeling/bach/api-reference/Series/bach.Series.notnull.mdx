...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">notnull(</span><small className="parameter-list"></small>)</h2>
...
[`isnull`](/docs/modeling/bach/api-reference/Series/bach.Series.isnull)
