...
<h2 className="signature-method"><span className="additional-name">Series.</span><span className="name">copy(</span><small className="parameter-list"></small>)</h2>
...
If you want to create a snapshot of the data, have a look at [`bach.DataFrame.get_sample()`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame.get-sample)
