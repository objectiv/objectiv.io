...
<h2 class="signature-method"><span class="additional-name">SeriesAbstractNumeric.</span><span class="name">qcut(</span><small class="parameter-list"><span class="parameter" id="q">q</span></small>)</h2>
