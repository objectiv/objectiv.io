...
* The property accessors [`Series.array`](/modeling/bach/api-reference/Series/bach.Series.array.mdx) and [`Series.value`](/modeling/bach/api-reference/Series/bach.Series.value.mdx)
...
* [`DataFrame.database_create_table()`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.database_create_table.mdx)
* [`DataFrame.from_pandas()`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.from_pandas.mdx), when called with `materialization=’table’`
* [`DataFrame.get_sample()`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.get_sample.mdx)
...
[`DataFrame.sort_values()`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.sort_values.mdx) or [`DataFrame.fillna()`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.fillna.mdx) call, then the order of the rows that
the data-transfer functions return can be unpredictable. In case for [`DataFrame.fillna()`](/modeling/bach/api-reference/DataFrame/bach.DataFrame.fillna.mdx),
