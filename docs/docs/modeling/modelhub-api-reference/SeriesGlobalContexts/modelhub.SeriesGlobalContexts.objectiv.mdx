...
<div>
<h2 class="signature-class"><span class="type-annotation"><em>property</em></span> <span class="additional-name">SeriesGlobalContexts.</span><span class="name">objectiv(</span>)</h2>
