...
<h2 class="signature-class"><span class="type-annotation"><em>property</em></span> <span class="additional-name">SeriesLocationStack.</span><span class="name">obj(</span>)</h2>
