...
Sets data from sql table into an [`bach.DataFrame`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame) object.
...
[`bach.DataFrame`](/docs/modeling/bach/api-reference/DataFrame/bach.DataFrame) with Objectiv data.
