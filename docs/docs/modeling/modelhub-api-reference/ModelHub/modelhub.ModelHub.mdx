...
<div class="class">
<h2 class="signature-method"><span class="type-annotation"><em>class</em></span> <span class="additional-name">modelhub.</span><span class="name">ModelHub(</span><small class="parameter-list"><span class="parameter" id="time_aggregation">time_aggregation='YYYY-MM-DD HH24:MI:SS.MS'</span></small>
