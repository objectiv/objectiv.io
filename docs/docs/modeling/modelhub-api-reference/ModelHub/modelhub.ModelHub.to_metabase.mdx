...
<div class="method">
<h2 class="signature-class"><span class="additional-name">ModelHub.</span><span class="name">to_metabase(</span><small class="parameter-list"><span class="parameter" id="data">data</span>, <span class="parameter" id="model_type">model_type=None</span>, <span class="parameter" id="config">config=None</span></small>
