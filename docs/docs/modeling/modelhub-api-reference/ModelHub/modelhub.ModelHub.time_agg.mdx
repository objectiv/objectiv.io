...
<div class="method">
<h2 class="signature-class"><span class="additional-name">ModelHub.</span><span class="name">time_agg(</span><small class="parameter-list"><span class="parameter" id="data">data</span>, <span class="parameter" id="time_aggregation">time_aggregation=None</span></small>
