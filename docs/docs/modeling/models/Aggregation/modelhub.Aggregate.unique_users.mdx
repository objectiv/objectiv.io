...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Aggregate.</span><span class="name">unique_users(</span><small class="parameter-list"><span class="parameter" id="data">data</span>, <span class="parameter" id="groupby">groupby=NotSet.token</span></small>
