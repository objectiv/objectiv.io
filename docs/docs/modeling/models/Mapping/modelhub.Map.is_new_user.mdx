...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Map.</span><span class="name">is_new_user(</span><small class="parameter-list"><span class="parameter" id="data">data</span>, <span class="parameter" id="time_aggregation">time_aggregation=None</span></small>
