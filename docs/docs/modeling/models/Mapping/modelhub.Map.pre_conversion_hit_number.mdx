...
<div class="method">
<h2 class="signature-class"><span class="additional-name">Map.</span><span class="name">pre_conversion_hit_number(</span><small class="parameter-list"><span class="parameter" id="data">data</span>, <span class="parameter" id="name">name</span>, <span class="parameter" id="partition">partition='session_id'</span></small>
