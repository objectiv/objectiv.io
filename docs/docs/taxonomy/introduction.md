...
Objectiv's [Tracker](/tracking/introduction.md), [Collector](/tracking/collector) and the [open model hub](/modeling/index.md) are built around the open taxonomy and support it out of the box.
