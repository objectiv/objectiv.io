...
The tracker will automatically set the id and _type based on the section element. When this is not possible on a specific platform, it will ask for a manual id and _type to be set.
:::