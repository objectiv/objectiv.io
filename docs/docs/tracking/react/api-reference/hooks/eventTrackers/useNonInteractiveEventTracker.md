...
Returns a ready-to-trigger [trackNonInteractiveEvent](/tracking/react/api-reference/eventTrackers/trackNonInteractiveEvent.md) by retrieving ReactTracker instance and LocationStack automatically.

```ts
useNonInteractiveEventTracker = (parameters: {
  tracker?: Tracker,
