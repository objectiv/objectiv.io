...
Returns a ready-to-trigger [trackInteractiveEvent](/tracking/react/api-reference/eventTrackers/trackInteractiveEvent.md) by retrieving ReactTracker instance and LocationStack automatically.

```ts
useInteractiveEventTracker = (parameters: {
  tracker?: Tracker,
