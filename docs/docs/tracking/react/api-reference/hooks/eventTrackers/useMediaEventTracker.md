...
Returns a ready-to-trigger [trackMediaEvent](/tracking/react/api-reference/eventTrackers/trackMediaEvent.md) by retrieving ReactTracker instance and LocationStack automatically.

```ts
useMediaEventTracker = (parameters: {
  tracker?: Tracker,
