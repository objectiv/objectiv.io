...
These Components wrap their children in a [LocationWrapper](/tracking/react/api-reference/locationWrappers/overview.md) and automatically trigger Events.
Some of them may also infer attributes, such as Pressable and Link identifiers.
