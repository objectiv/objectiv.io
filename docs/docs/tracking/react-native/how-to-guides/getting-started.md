...
[React Native Tracker](/tracking/react-native/api-reference/ReactNativeTracker.md) is quite modular, and it's possible to set it up without having a [Collector](/tracking/collector/introduction.md) running.
