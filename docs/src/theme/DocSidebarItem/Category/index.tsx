...
import { EventTrackerHookParameters, ExpandableContextWrapper, trackVisibility, useLocationStack, useOnChange, useTracker } from '@objectiv/tracker-react';
...
export default function DocSidebarItemCategory({
  ...
  useOnChange(collapsed, () => trackVisibility({isVisible: !collapsed}));
  
  return (
    // OBJECTIV
    <ExpandableContextWrapper id={label}>
      {/* {(trackingContext) => ( */}
        <li
          // onClick={(collapsed) => trackVisibility({ 
          //   ...trackingContext, 
          //   isVisible: !collapsed
          // })}
          className={clsx(
